    ...
    )
{
    ...
    if (*ppMsiTransaction && (!pMsiTransaction || pMsiTransaction != *ppMsiTransaction))
    {
        ...
        *ppMsiTransaction = NULL;
        ...
        hr = UserExperienceOnPlanMsiTransactionComplete(pUX, pEndingMsiTransaction->sczId, pEndingMsiTransaction->dwPackages, pEndingMsiTransaction->fPlanned);
    ...
    )
{
    ...
    hr = UserExperienceOnPlanMsiTransaction(pUX, pMsiTransaction->sczId, &pMsiTransaction->fPlanned);

    ...
    public static partial class SymbolDefinitions
    {
        public static readonly IntermediateSymbolDefinition WixBundleContainer = new IntermediateSymbolDefinition(
            ...
            new[]
            {
                ...
                new IntermediateFieldDefinition(nameof(WixBundleContainerSymbolFields.BootstrapperExtensionRef), IntermediateFieldType.String),
            },
...
namespace WixToolset.Data.Symbols
{
    ...
    public class WixBundleContainerSymbol : IntermediateSymbol
    {
        ...
        {
            get => (string)this.Fields[(int)WixBundleContainerSymbolFields.BootstrapperExtensionRef];
            set => this.Set((int)WixBundleContainerSymbolFields.BootstrapperExtensionRef, value);
        }
    }
}
